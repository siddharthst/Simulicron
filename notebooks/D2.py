...
'''
# 100
sim   = runBatch(numberOfSimulations=1, NumberOfTransposonInsertions=2, baseSelection=-0.02, 
...
# 100
sim   = runBatch(numberOfSimulations=1, NumberOfTransposonInsertions=2, baseSelection=-0.02, 
                    baseExcision=0.03, numberOfChromosomes=1, baseRecombinationRate=0.0, 
                    NumberOfIndividual=1000, InsertIntoAll=True, NumberOfGenerations=200)
...
with open("d2P1000u04.pickle", "wb") as f:
    pickle.dump((sim), f)
               ...
               '''
sim   = runBatch(numberOfSimulations=1, NumberOfTransposonInsertions=2, baseSelection=-0.02, 
                    baseExcision=0.05, numberOfChromosomes=1, baseRecombinationRate=0.0, 
                    NumberOfIndividual=1000, InsertIntoAll=True, NumberOfGenerations=200)
with open("d2P1000u05.pickle", "wb") as f:
    pickle.dump((sim), f)

sim   = runBatch(numberOfSimulations=1, NumberOfTransposonInsertions=2, baseSelection=-0.02, 
                    baseExcision=0.06, numberOfChromosomes=1, baseRecombinationRate=0.0, 
                    NumberOfIndividual=1000, InsertIntoAll=True, NumberOfGenerations=200)
