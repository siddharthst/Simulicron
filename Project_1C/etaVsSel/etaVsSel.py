...
parameters = {
    "generations": 5000,
    "individuals": 500,
    "selectionPenaltyMin": 0.00001,
    "selectionPenaltyMax": 0.01,
    "etaMin": 0.0,
    "etaMax": 1.0,
    "tauMin": 1.0,
    "tauMax": 1.0,
...
def worker(parameters):
    ...
    selectionCoef = - np.exp(np.random.uniform(
        np.log(parameters["selectionPenaltyMin"]),
        np.log(parameters["selectionPenaltyMax"]),
    ))
